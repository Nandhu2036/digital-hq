...
const PROFILE_DATA = {
  ...
  personal: {
    name: "NANDHAKUMAR G",
    title: "Mechanical Engineering | Digital Workflows & Operations",
  ...
  // Metric Snapshots
  metrics: [
    { value: "4", label: "Industry Internships", icon: "business_center" },
  ...
  journey: [
    {
      ...
      institution: "St. Josephâ€™s College of Engineering, Chennai, Tamil Nadu",
      type: "education",
    ...
    },
    {
      ...
      type: "internship",
      details: "Performed dimensional inspection, parametric CAD modeling, and print optimization for legacy components.",
      milestones: [
        "Captured high-accuracy dimensional data of mechanical systems using precision metrology tools to establish baseline technical documentation.",
        "Executed digital engineering workflows to reconstruct physical geometries into parametric 3D models, resolving design deviations and model geometry errors.",
        "Performed tolerance stack analysis and clearance checks to validate cross-functional compatibility with modern assemblies prior to print layout optimization."
      ]
    },
    {
      year: "December 2025",
    ...
    },
    {
      ...
      milestones: [
        ...
        "Reviewed structural interface specifications and fasteners selection, ensuring compliance with manufacturing (DFM) requirements and assembly tolerances.",
    ...
    },
    {
      ...
      milestones: [
        "Conducted process analysis on packaging layouts, developing workflow optimization schemes that successfully increased output rates by 10%.",
        "Established structured shipping layouts and packaging specifications, improving information organization to protect mechanical parts during logistics cycles.",
        "Provided engineering support during diagnostics and scheduled preventive maintenance, tracing mechanical issues to reduce machinery downtime parameters by 15%."
      ]
    },
    {
      year: "2022 - 2023",
  ...
  cadVault: [
    {
      ...
      filePath: "assets/cad-models/v12_engine.png",
      cadSource: "assets/cad-models/v12_engine.f3d",
      description: "Full parametric assembly of a V12 automotive engine, modeling crankshaft, pistons, connecting rods, and engine block.",
      software: null,
      date: "2025-06-20",
      tags: ["V12 Engine", "Automotive", "Complex Assembly"],
      relatedContent: { text: "Archive Explorer", link: "archive-explorer" },
      drawings: null,
      category: "Mechanical Assemblies",
      subCategory: "Engines",
      viewpoints: ["assets/cad-models/v12_engine.png"]
    },
    {
      ...
      relatedContent: { text: "Archive Explorer", link: "archive-explorer" },
      drawings: "assets/drawings/radial_engine_drawing.pdf",
      category: "Mechanical Assemblies",
      subCategory: "Engines",
    ...
    },
    {
      ...
      type: "Product Assembly",
      filePath: "assets/cad-models/v6_engine.jpg",
      cadSource: "assets/cad-models/v6_engine.f3d",
      description: "Detailed V6 engine assembly design with crankshaft linkages and combustion cylinder clearances.",
      software: null,
      date: "2025-06-20",
      tags: ["V6 Engine", "Powertrain", "Linkages"],
      relatedContent: { text: "Archive Explorer", link: "archive-explorer" },
      drawings: null,
      category: "Mechanical Assemblies",
      subCategory: "Engines",
      viewpoints: ["assets/cad-models/v6_engine.jpg"]
    },
    {
      id: "vehicle-suspension-assy",
      title: "Vehicle Double Wishbone Suspension",
      type: "Product Assembly",
      filePath: "assets/cad-models/vehicle_suspension.png",
      cadSource: "assets/cad-models/vehicle_suspension.f3d",
      description: "Automotive front suspension assembly including control arms, steering knuckle, shock absorber, and brake disc hubs.",
      software: null,
      date: "2025-06-20",
      tags: ["Suspension", "Wishbone", "Automotive Linkage"],
      relatedContent: { text: "Archive Explorer", link: "archive-explorer" },
      drawings: null,
      category: "Mechanical Assemblies",
      subCategory: "Heavy Equipment",
      viewpoints: ["assets/cad-models/vehicle_suspension.png"]
    },
    {
      id: "jcb-controller-assy",
      title: "JCB Controller Valve Block Assembly",
      type: "Product Assembly",
      filePath: "assets/cad-models/jcb_controller.png",
      cadSource: "assets/cad-models/jcb_controller.3mf",
      description: "Hydraulic backhoe controller assembly modeling structural arms, cylinder attachments, and controller pins.",
      software: null,
      date: "2025-06-20",
      tags: ["JCB Controller", "Hydraulics", "Valve Block"],
      relatedContent: { text: "Archive Explorer", link: "archive-explorer" },
      drawings: null,
      category: "Mechanical Assemblies",
      subCategory: "Heavy Equipment",
      viewpoints: ["assets/cad-models/jcb_controller.png"]
    },
    {
      id: "river-cleaner-assy",
      title: "Clear Wave Catamaran Hull Assembly",
      type: "Product Assembly",
      filePath: "assets/cad-models/river_cleaning_robot.png",
      cadSource: "assets/cad-models/river_cleaning_robot.f3d",
      description: "Twin-hull catamaran design optimized for river debris collection, utilizing lightweight structural frames.",
      software: null,
      date: "2026-03-24",
      tags: ["Catamaran", "Hull", "River Clean Robot"],
      relatedContent: { text: "Project EcoFloat", link: "ecofloat" },
      drawings: null,
      category: "Mechanical Assemblies",
      subCategory: "Heavy Equipment",
      viewpoints: ["assets/cad-models/river_cleaning_robot.png"]
    },
    {
      id: "robotic-waste-coll-assy",
      title: "Robotic Waste Collector Unit",
      type: "Product Assembly",
      filePath: "assets/cad-models/robotic_waste_collector.png",
      cadSource: "assets/cad-models/robotic_waste_collector.f3d",
      description: "Automated mechanical grabber assembly for robotic waste collectors, verifying clearances and kinematics.",
      software: null,
      date: "2025-06-20",
      tags: ["Grabber Claw", "Waste Collector", "Robotics"],
      relatedContent: { text: "Archive Explorer", link: "archive-explorer" },
      drawings: null,
      category: "Mechanical Assemblies",
      subCategory: "Heavy Equipment",
      viewpoints: ["assets/cad-models/robotic_waste_collector.png"]
    },
    {
      id: "industrial-motor-assy",
      title: "Industrial AC Motor Assembly",
      type: "Product Assembly",
      filePath: "assets/cad-models/industrial_ac_motor.png",
      cadSource: "assets/cad-models/industrial_ac_motor.f3d",
      description: "Complete industrial AC motor assembly design detailing stator housing, rotor shaft, bearings, and terminal block.",
      software: null,
      date: "2025-06-20",
      tags: ["AC Motor", "Electrical Machine", "Industrial Drive"],
      relatedContent: { text: "Archive Explorer", link: "archive-explorer" },
      drawings: null,
      category: "Mechanical Assemblies",
      subCategory: "Heavy Equipment",
      viewpoints: ["assets/cad-models/industrial_ac_motor.png"]
    },
    {
      id: "rc-plane-wing",
      title: "Groover 60 RC Plane Wing Assembly",
      type: "Product Assembly",
      filePath: "assets/cad-models/rc_plane.png",
      cadSource: "assets/cad-models/rc_plane.f3d",
      description: "Symmetrical wing structure for Groover 60 RC plane, detailing internal ribs layouts and stabilizer attachment interfaces.",
      software: null,
      date: "2025-06-20",
      tags: ["RC Plane", "Wing Assembly", "Aerostructure"],
      relatedContent: { text: "Archive Explorer", link: "archive-explorer" },
      drawings: null,
      category: "Projects",
      subCategory: "Product Concepts",
      viewpoints: ["assets/cad-models/rc_plane.png"]
    },
    {
      ...
      cadSource: "assets/cad-models/traction_wheel.f3d",
    ...
    },
    {
      ...
      category: "Projects",
      subCategory: "Product Concepts",
      viewpoints: ["assets/cad-models/2025-05-04_1738687165f52.webp"]
    },
    {
      id: "turntable-geared-assembly",
      title: "Rotational Geared Turntable Assembly",
      type: "Product Assembly",
      filePath: "assets/cad-models/turntable/IMG_6450.JPG",
      cadSource: null,
      ...
      category: "Projects",
      subCategory: "Product Concepts",
      viewpoints: ["assets/cad-models/turntable/IMG_6450.JPG", "assets/cad-models/turntable/IMG_6451.jpg", "assets/cad-models/turntable/39AECF0E-4C62-4B8C-89B1-AA7D28F61425.JPG", "assets/cad-models/turntable/5F256617-A3F6-4D15-8CCE-0D2EB27328FE.JPG", "assets/cad-models/turntable/852AFF5E-669C-4A0C-ADC0-3D646E2127DD.JPG", "assets/cad-models/turntable/BEE1E7DA-A88B-4646-A2A4-A621697EB647.JPG"]
    },
    {
      id: "geneva-wheel",
      title: "Geneva Wheel Mechanism",
      type: "Product Assembly",
      filePath: "assets/cad-models/geneva_wheel.png",
      cadSource: "assets/cad-models/geneva_wheel.f3d",
      ...
      viewpoints: ["assets/cad-models/geneva_wheel.png"]
    },
    {
      id: "groove-cam",
      title: "Groove Cam & Follower Mechanism",
      type: "Product Assembly",
      filePath: "assets/cad-models/groove_cam.png",
      cadSource: "assets/cad-models/groove_cam.f3d",
      ...
      category: "Mechanical Assemblies",
      subCategory: "Mechanisms",
      viewpoints: ["assets/cad-models/groove_cam.png"]
    },
    {
      id: "wobbling-disk-mechanism",
      title: "Wobbling Disk Pump Mechanism",
      type: "Product Assembly",
      filePath: "assets/cad-models/wobbling_disk.png",
      cadSource: "assets/cad-models/wobbling_disk.f3d",
      ...
      category: "Mechanical Assemblies",
      subCategory: "Mechanisms",
      viewpoints: ["assets/cad-models/wobbling_disk.png"]
    },
    {
      id: "toy-grabber",
      title: "Toy Grabber Mechanical Claw",
      type: "Product Assembly",
      filePath: "assets/cad-models/toy_grabber.png",
      cadSource: "assets/cad-models/toy_grabber.f3d",
      ...
      category: "Projects",
      subCategory: "Product Concepts",
      viewpoints: ["assets/cad-models/toy_grabber.png"]
    },
    {
      ...
      cadSource: "assets/cad-models/cardan_joint.f3d",
    ...
    },
    {
      ...
      cadSource: "assets/cad-models/universal_coupling.prt",
    ...
    },
    {
      ...
      cadSource: "assets/cad-models/axial_turbine_wheel.f3d",
    ...
    },
    {
      ...
      cadSource: "assets/cad-models/slot_cam_four_sliding.f3d",
    ...
    },
    {
      ...
      type: "Product Assembly",
      filePath: "assets/cad-models/spur_gear_spinner.png",
      cadSource: "assets/cad-models/spur_gear_spinner.f3d",
      ...
      category: "Mechanical Assemblies",
      subCategory: "Mechanisms",
      viewpoints: ["assets/cad-models/spur_gear_spinner.png"]
    },
    {
      id: "generated-rotor",
      title: "Generated Aerodynamic Rotor",
      type: "Product Assembly",
      filePath: "assets/cad-models/rotor.png",
      cadSource: "assets/cad-models/rotor.f3d",
      ...
      category: "Mechanical Assemblies",
      subCategory: "Mechanisms",
      viewpoints: ["assets/cad-models/rotor.png"]
    },
    {
      id: "rocker-arm",
      title: "Rocker Arm Lever Mechanism",
      type: "Product Assembly",
      filePath: "assets/cad-models/rocker_arm.png",
      cadSource: "assets/cad-models/rocker_arm.f3d",
      ...
      category: "Mechanical Assemblies",
      subCategory: "Mechanisms",
      viewpoints: ["assets/cad-models/rocker_arm.png"]
    },
    {
      id: "schmidt-coupling",
      ...
      cadSource: "assets/cad-models/schidmth_coupling.f3d",
    ...
    },
    {
      ...
      cadSource: "assets/cad-models/piston_cylinder.f3d",
    ...
    },
    {
      ...
      cadSource: "assets/cad-models/ball_joint.f3d",
    ...
    },
    {
      ...
      cadSource: "assets/cad-models/cam_follower.f3d",
    ...
    },
    {
      ...
      type: "Product Assembly",
      filePath: "assets/cad-models/knuckle_joint.png",
      cadSource: "assets/cad-models/knuckle_joint_v1.f3d",
      ...
      category: "Mechanical Assemblies",
      subCategory: "Mechanisms",
      viewpoints: ["assets/cad-models/knuckle_joint.png"]
    },
    {
      ...
      cadSource: "assets/cad-models/rachet_pawl.f3d",
    ...
    },
    {
      ...
      cadSource: "assets/cad-models/dual_clevis_mount.f3d",
      ...
      relatedContent: { text: "Archive Explorer", link: "archive-explorer" },
      drawings: "assets/drawings/dual_clevis_mount_drawing.pdf",
      category: "Mechanical Assemblies",
      subCategory: "Mechanisms",
    ...
    },
    {
      ...
      type: "Product Assembly",
      filePath: "assets/cad-models/slider_crank.png",
      cadSource: "assets/cad-models/slider_crank.f3d",
      ...
      category: "Mechanical Assemblies",
      subCategory: "Mechanisms",
      viewpoints: ["assets/cad-models/slider_crank.png"]
    },
    {
      id: "catamaran-hulls",
    ...
    },
    {
      ...
      filePath: "assets/cad-models/plumer_jack.png",
      cadSource: null,
      ...
      category: "Others",
      subCategory: "Drafts",
      viewpoints: ["assets/cad-models/plumer_jack.png"]
    },
    {
      id: "spreader-hopper",
      ...
      category: "Projects",
      subCategory: "Product Concepts",
      viewpoints: ["assets/cad-models/2025-05-04_aac909828bd768.webp"]
    },
    {
    ...
    },
    {
      ...
      cadSource: "assets/cad-models/20250130_092000_mesh.stl",
    ...
    },
    {
      ...
      category: "Practice Parts",
      subCategory: "Daily Challenges",
    ...
    },
    {
      ...
      cadSource: "assets/cad-models/challenge/Day 9.f3d",
    ...
    },
    {
      ...
      cadSource: "assets/cad-models/challenge/Day 8.f3d",
    ...
    },
    {
      ...
      cadSource: "assets/cad-models/challenge/Day 7.f3d",
    ...
    },
    {
      ...
      cadSource: "assets/cad-models/challenge/Day 6.f3d",
  ...
  internships: [
    {
      ...
      division: "Reverse Engineering Division",
      logo: "settings_backup_restore",
      role: "Reverse Engineering Intern",
      duration: "June 2026",
      document: null,
      certificate: null,
      responsibilities: [
      ...
      learnings: "Developed deep competency in dimensional reverse engineering, parametric CAD modeling reconstructions, tolerance stack analyses, and FDM print parameter optimization."
    },
    {
...
for (let i = 1; i <= 28; i++) {
  PROFILE_DATA.cadVault.push({
    ...
    type: `CAD Exercise`,
    filePath: `assets/cad-models/exercises/Ex_${i}.png`,
    cadSource: `assets/cad-models/exercises/Ex_${i}.f3d`,
    ...
    drawings: null,
    category: "Practice Parts",
    subCategory: "Exercises 1-28",
    viewpoints: [`assets/cad-models/exercises/Ex_${i}.png`]
  });
}
